    ...
    public class DatabaseContextSeed
    {
        public static async Task SeedAsync(DatabaseContext context,ILoggerFactory loggerFactory)
        {
            try
            {
                ...
                {
                    var brandDatas = File.ReadAllText("../Kitab.DataAccess/SeedData/brands.json");
                    var brands = JsonSerializer.Deserialize<List<ProductBrandEntity>>(brandDatas);
                    context.tProductBrand.AddRange(brands);
                    await context.SaveChangesAsync();

                    var productTypeDatas = File.ReadAllText("../Kitab.DataAccess/SeedData/types.json");
                    ...
                    var productDatas = File.ReadAllText("../Kitab.DataAccess/SeedData/products.json");
                ...
                {
                    var dmData = File.ReadAllText("../Kitab.DataAccess/SeedData/delivery.json");
